...
# ══════════════════════════════════════════════════════════════════════════════
ERA5_CSV = r"/mnt/d/LSTM/hardinge/ERA5_Ganges_All.csv"
WL_CSV   = r"/mnt/d/LSTM/hardinge/daily_wl_SW90.csv"
OUT_DIR  = r"/mnt/d/LSTM/hardinge/outputs"

# ══════════════════════════════════════════════════════════════════════════════
#  HYPERPARAMETERS
# ══════════════════════════════════════════════════════════════════════════════
HINDCAST_LEN = 60    # days of history the LSTM reads per sample
